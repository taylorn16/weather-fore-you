...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'bower_components/formstone/dist/js/analytics.js',
      'bower_components/formstone/dist/js/asap.js',
      ...
      'bower_components/formstone/dist/js/cookie.js',
      ...
      'bower_components/formstone/dist/js/number.js',
      'bower_components/formstone/dist/js/pagination.js',
      'bower_components/formstone/dist/js/range.js',
      'bower_components/formstone/dist/js/scrollbar.js',
      'bower_components/formstone/dist/js/swap.js',
      'bower_components/formstone/dist/js/tabs.js',
